...
impl LndClient {
    ...
    /// unlock/release the locked UTXOs in case of an error on the caller's side.
    ...
    /// either publish the transaction on success or unlock/release any locked UTXOs in case of an error in this method.
